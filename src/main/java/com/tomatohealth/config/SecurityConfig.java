...
import com.tomatohealth.security.JwtAuthEntryPoint;
import com.tomatohealth.security.JwtAuthenticationFilter;
...
/**
 * Spring Security configuration with JWT authentication, CORS, and stateless sessions.
 */
@Configuration
@EnableWebSecurity
